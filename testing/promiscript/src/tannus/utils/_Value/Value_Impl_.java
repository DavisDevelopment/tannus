...
public final class Value_Impl_
{
	...
	public static <T> T get_v(tannus.utils.CValue<T> this1)
	{
	...
	public static <T> T set_v(tannus.utils.CValue<T> this1, T nv)
	{
		//line 50 "/home/ryan/Dropbox/MyCloudCode/Tannus/src/tannus/utils/Value.hx"
		return this1.set(nv);
	}
	
	
	public static <T> void watch(tannus.utils.CValue<T> this1, haxe.lang.Function f)
	{
		//line 54 "/home/ryan/Dropbox/MyCloudCode/Tannus/src/tannus/utils/Value.hx"
		this1.on("change", new tannus.utils._Value.Value_Impl__watch_54__Fun<T>(f, this1), null);
	}
	
	
	public static <T> T toType(tannus.utils.CValue<T> this1)
	{
		//line 59 "/home/ryan/Dropbox/MyCloudCode/Tannus/src/tannus/utils/Value.hx"
		return this1.get();
	}
	
	
	public static <T> tannus.utils.CValue<T> toUnderlying(tannus.utils.CValue<T> this1)
	{
		//line 64 "/home/ryan/Dropbox/MyCloudCode/Tannus/src/tannus/utils/Value.hx"
		return ((tannus.utils.CValue<T>) (this1) );
	}
