...
public class StringMap<T> extends haxe.lang.HxObject implements haxe.IMap<java.lang.String, T>
{
	...
	public static <T_c> void __hx_ctor_haxe_ds_StringMap(haxe.ds.StringMap<T_c> __temp_me9)
	{
		//line 61 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
		__temp_me9.cachedIndex = -1;
	}
		...
		//line 76 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
		{
			...
			else
			{
				...
				do 
				{
					...
					//line 88 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
					boolean __temp_boolv47 = false;
					//line 88 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
					if ( ! (__temp_stmt46) ) 
					{
						//line 88 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
						__temp_boolv47 = ( ( flag == k ) && haxe.lang.Runtime.valEq(this._keys[i], key) );
					}
					
					//line 88 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
					boolean __temp_stmt45 = ( __temp_stmt46 || __temp_boolv47 );
	...
	public int lookup(java.lang.String key)
	{
		...
		if (( this.nBuckets != 0 )) 
		{
			...
			do 
			{
				...
				//line 139 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
				boolean __temp_boolv50 =  ! (__temp_stmt51) ;
				//line 139 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
				boolean __temp_boolv49 = false;
				//line 139 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
				if (__temp_boolv50) 
				{
					//line 139 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
					__temp_boolv49 = (( ( ( flag == 1 ) || ( flag != k1 ) ) ||  ! (haxe.lang.Runtime.valEq(keys[i], key))  ));
				}
				
				//line 139 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
				boolean __temp_stmt48 = ( __temp_boolv50 && __temp_boolv49 );
	...
	public void resize(int newNBuckets)
	{
		...
		if (( j != 0 )) 
		{
			...
			while ((  ++ j < nBuckets ))
			{
				...
				boolean __temp_stmt52 = false;
				//line 202 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
				{
					//line 202 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
					int v1 = k1 = hashes[j];
					//line 202 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
					__temp_stmt52 = ( (( v1 & -2 )) == 0 );
				}
				...
				if ( ! (__temp_stmt52) ) 
				{
					...
					while (true)
					{
						...
						boolean __temp_boolv55 = ( i < nBuckets );
						//line 219 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
						boolean __temp_boolv54 = false;
						//line 219 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
						if (__temp_boolv55) 
						{
							//line 219 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
							boolean __temp_stmt56 = false;
							//line 219 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
							{
								//line 219 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
								int v2 = k1 = hashes[i];
								//line 219 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
								__temp_stmt56 = ( (( v2 & -2 )) == 0 );
							}
							
							//line 219 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
							__temp_boolv54 =  ! (__temp_stmt56) ;
						}
						
						//line 219 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
						boolean __temp_stmt53 = ( __temp_boolv55 && __temp_boolv54 );
						//line 219 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
						if (__temp_stmt53) 
						{
	...
	public java.lang.Object iterator()
	{
		...
		//line 386 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
		{
			...
			haxe.lang.Function __temp_odecl57 = new haxe.ds.StringMap_iterator_387__Fun<T>(_g1, len, i);
			//line 398 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
			haxe.lang.Function __temp_odecl58 = new haxe.ds.StringMap_iterator_398__Fun<T>(_g1, i);
			//line 386 "/usr/lib/haxe/std/java/_std/haxe/ds/StringMap.hx"
			return new haxe.lang.DynamicObject(new haxe.root.Array<java.lang.String>(new java.lang.String[]{"hasNext", "next"}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{__temp_odecl57, __temp_odecl58}), new haxe.root.Array<java.lang.String>(new java.lang.String[]{}), new haxe.root.Array<java.lang.Object>(new java.lang.Object[]{}));
		}
