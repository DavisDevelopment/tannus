...
public class Std
{
	...
	public static boolean is(java.lang.Object v, java.lang.Object t)
	{
		...
		{
			//line 39 "/usr/lib/haxe/std/java/_std/Std.hx"
			java.lang.String __temp_svar36 = (name);
			//line 39 "/usr/lib/haxe/std/java/_std/Std.hx"
			int __temp_hash38 = __temp_svar36.hashCode();
			//line 39 "/usr/lib/haxe/std/java/_std/Std.hx"
			switch (__temp_hash38)
			{
				case 761287205:
				case -1325958191:
				{
					//line 42 "/usr/lib/haxe/std/java/_std/Std.hx"
					if (( (( ( __temp_hash38 == 761287205 ) && __temp_svar36.equals("java.lang.Double") )) || __temp_svar36.equals("double") )) 
					{
						//line 42 "/usr/lib/haxe/std/java/_std/Std.hx"
				...
				case 1063877011:
				{
					...
					if (__temp_svar36.equals("java.lang.Object")) 
					{
						//line 48 "/usr/lib/haxe/std/java/_std/Std.hx"
						return true;
					}
				...
				case 104431:
				{
					...
					if (( (( ( __temp_hash38 == -2056817302 ) && __temp_svar36.equals("java.lang.Integer") )) || __temp_svar36.equals("int") )) 
					{
						//line 44 "/usr/lib/haxe/std/java/_std/Std.hx"
				...
				case 64711720:
				{
					...
					if (( (( ( __temp_hash38 == 344809556 ) && __temp_svar36.equals("java.lang.Boolean") )) || __temp_svar36.equals("boolean") )) 
					{
						//line 46 "/usr/lib/haxe/std/java/_std/Std.hx"
