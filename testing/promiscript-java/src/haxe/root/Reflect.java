...
public class Reflect extends haxe.lang.HxObject
{
	...
	public Reflect()
	{
		//line 26 "/usr/lib/haxe/std/java/_std/Reflect.hx"
	...
	{
		//line 177 "/usr/lib/haxe/std/java/_std/Reflect.hx"
		...
		//line 178 "/usr/lib/haxe/std/java/_std/Reflect.hx"
		{
			//line 178 "/usr/lib/haxe/std/java/_std/Reflect.hx"
			int _g = 0;
			//line 178 "/usr/lib/haxe/std/java/_std/Reflect.hx"
			...
			while (( _g < _g1.length ))
			{
				...
				//line 178 "/usr/lib/haxe/std/java/_std/Reflect.hx"
				 ++ _g;
				//line 179 "/usr/lib/haxe/std/java/_std/Reflect.hx"
				haxe.root.Reflect.setField(o2, f, haxe.root.Reflect.field(o, f));
			}
			
		}
		
		//line 180 "/usr/lib/haxe/std/java/_std/Reflect.hx"
		return ((T) (o2) );
	}
	...
	{
		//line 186 "/usr/lib/haxe/std/java/_std/Reflect.hx"
